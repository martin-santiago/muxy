...
enum ShortcutAction: String, Codable, CaseIterable, Identifiable {
    ...
    static let allCases: [Self] = [
        ...
        .quickOpen,
        .switchWorktree,
        .toggleSelectedProjectExpansion,
        .saveFile,
        .toggleSidebar,
        .toggleFileTree,
    ]
    ...
    private var metadata: ShortcutMetadata {
        ...
        case .toggleSelectedProjectExpansion: ShortcutMetadata(
                displayName: "Expand/Collapse Selected Project",
...
struct KeyBinding: Codable, Identifiable {
    ...
    static let defaults: [Self] = [
        ...
        Self(action: .toggleSelectedProjectExpansion, combo: KeyCombo(key: "\\", control: true)),
